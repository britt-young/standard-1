    ...
    <RippleProvider>
      <div className="flex flex-col mx-auto bg-white w-full max-w-lg rounded-xl p-8 shadow-lg">
        ...
        >
          ...
          <button
            type="submit"
            className="mt-5 self-start bg-green-600 w-full rounded-full border-2 border-green-600 px-8 py-4 text-center text-white uppercase shadow-md shadow-gray-600 hover:bg-transparent hover:text-black transition duration-500 cursor-pointer"
          >
            Send
          </button>
        </form>
