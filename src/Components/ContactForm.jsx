        ...
        >
          ...
          <label className="flex flex-col text-gray-700 font-medium">
            ...
            <input
              ...
              className="mt-1 px-4 py-2 rounded-md border border-gray-300 bg-gray-100 focus:outline-none focus:ring-2 focus:ring-green-600"
            />
          </label>
          ...
          <div className="flex flex-col text-gray-700">
            ...
            <span className="mb-2 font-medium">Select a Service:</span>
          ...
          <button
            type="submit"
            className="mt-5 self-start bg-green-900 w-full rounded-full border-2 border-green-900 px-8 py-4 text-center text-white uppercase shadow-md shadow-gray-600 hover:bg-transparent hover:text-black transition duration-500 cursor-pointer"
          >
            Send
          </button>
        </form>
